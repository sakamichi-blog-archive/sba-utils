...
Merging that Release PR publishes the package to npm via [npm trusted publishing](https://docs.npmjs.com/generating-provenance-statements) (OIDC — no token required).
