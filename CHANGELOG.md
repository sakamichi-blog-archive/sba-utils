...
## [0.10.0](https://github.com/sakamichi-blog-archive/sba-utils/compare/utils-v0.9.1...utils-v0.10.0) (2026-09-23)


### ⚠ BREAKING CHANGES

* `Member.nameEnglish` and `Member.nameKana` are now optional. The non-member blog accounts omit both, since no official website lists them.

### Features

* Add member kana and use official English names ([#114](https://github.com/sakamichi-blog-archive/sba-utils/issues/114)) ([177d7ef](https://github.com/sakamichi-blog-archive/sba-utils/commit/177d7ef2eab4b1358fe2c3e3581e2bf69bfa8e8d))
